...
var lambdaHandler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
                    body = (0, event_processor_1.eventProcessor)({
                        type: 'object',
                        properties: {
                    ...
                    message = void 0;
                    if (err instanceof event_processor_1.EmptyBodyError) {
                        message = 'A username must be provided to this request.';
                    }
                    else if (err instanceof event_processor_1.InvalidBodyError) {
                ...
                playerSecret = (0, crypto_1.randomBytes)(20).toString('hex');
                params = {
                    TableName: 'Players',
                    Item: {
                        'Id': playerId,
                ...
                docClient = new dynamodb_1.DocumentClient({
